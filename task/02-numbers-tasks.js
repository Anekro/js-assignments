...
function getAverage(value1, value2) {
    var average = (x, y) => Math.min(x, y) + Math.abs(x - y) / 2;
    return Number.isFinite(average(value1, value2)) ? average(value1, value2) : (value1 + value2) / 2;
}
...
function toNumber(value, def) {
    return Number.isInteger(Number.parseInt(value)) ? value : def;
}
